        ...
        <div class="col-12">
          <nav class="main-nav">
            ...
            <a href="index.html" class="logo">
              <img src="{{ asset('img/logo1.png') }}" height="44px">
            </a>
            <!-- ***** Logo End ***** -->
            <!-- ***** Menu Start ***** -->
            <ul class="nav">
              <li class="scroll-to-section"><a href="#top" class="active">Home</a></li>
              <li class="scroll-to-section"><a href="#services">Work Program</a></li>
              <li class="scroll-to-section"><a href="#about">About</a></li>
              <li class="scroll-to-section"><a href="#portfolio">Portfolio</a></li>
              <li class="scroll-to-section"><a href="#video">Videos</a></li>
              <li class="scroll-to-section"><a href="#contact">Contact Us</a></li>
              <li class="scroll-to-section"><div class="main-red-button-hover"><a href="https://api.whatsapp.com/send?phone=6285256530395" target="_blank">Contact Us Now</a></div></li>
            </ul>
      ...
      <div class="row">
        <div class="col-lg-6 offset-lg-3">
          <div class="section-heading">
            <h2>Our <em>Work Programs</em> Are Available In Several <span>Countries</span></h2>
            <span>Work Programs</span>
          </div>
        </div>
      </div>
      <div class="row">
        <div class="col-lg-12">
          <div class="owl-carousel owl-services">
            <div class="item">
              <h4>Japan</h4>
              <div class="icon"><img src="{{ asset('img/japan_flag.png') }}" alt=""></div>
              {{-- <p>Feel free to use this template for your business</p> --}}
              <p><small>
                    <ol>
                        <li>Wakaf Al-Quran Untuk Masjid</li>
                        <li>Wakaf Al-Quran Untuk Mualaf</li>
                        <li>Kegiatan Sosial Jumat Berkah</li>
                    </ol>
              </small></p>
            </div>
            <div class="item">
              <h4>Indonesian</h4>
              <div class="icon"><img src="{{ asset('img/indonesia_flag.png') }}" alt=""></div>
              {{-- <p>Get to know more about the topic in details</p> --}}
              <p><small>
                <ol>
                    <li>Wakaf Al-Quran Untuk Panti Asuhan</li>
                    <li>Wakaf Al-Quran Untuk Hafidz</li>
                    <li>Wakaf Al-Quran untuk Taman Pendidikan Alqur’an (TPA)</li>
                    <li>Wakaf Al-Quran Untuk Masjid</li>
                    <li>Kegiatan Sosial Berbagi Sembako</li>
                    <li>Safari Dakwah Di Pelosok Indonesia</li>
            ...
            <div class="item">
              <h4>Malaysia</h4>
              <div class="icon"><img src="{{ asset('img/malaysia_flag.png') }}" alt=""></div>
              {{-- <p>Get to know more about the topic in details</p> --}}
              <p><small>
                <ol>
                    <li>Wakaf Al-Quran untuk Taman Pendidikan Alqur’an (TPA)</li>
            ...
            <div class="item">
              <h4>South Korea</h4>
              <div class="icon"><img src="{{ asset('img/south_korea_flag.png') }}" alt=""></div>
              <p>On Progress</p>
            </div>
            <div class="item">
              <h4>Solomon Islands</h4>
              <div class="icon"><img src="{{ asset('img/solomo_islands_flasg.png') }}" alt=""></div>
              <p>On Progress</p>
            </div>
            {{-- <div class="item">
      ...
      <div class="row">
        <div class="col-lg-6 align-self-center">
          <div class="left-image">
            <img src="{{ asset('img/img3.png') }}" alt="Two Girls working together">
          </div>
        </div>
        <div class="col-lg-6">
          <div class="section-heading">
            <h2>Mari bergabung bersama kami <em>QS</em> <span>JAPAN CENTER</span></h2>
            <p>Salurkan donasi/sedekah terbaik anda kepada penghafal Al-Quran dan orang yang mempelajari Al-Quran<br><br>
                <small>Dari Abu Hurairah radhiyallahu ‘anhu, Nabi shallallahu ‘alaihi wa sallam bersabda<br><br>
                <i>“Sesungguhnya yang didapati oleh orang yang beriman dari amalan dan kebaikan yang ia lakukan setelah ia mati adalah Ilmu yang ia ajarkan dan sebarkan, Anak shalih yang ia tinggalkan, Mushaf Al-Qur’an yang ia wariskan, Masjid yang ia bangun, Rumah bagi ibnu sabil (musafir yang terputus perjalanan) yang ia bangun, Sungai yang ia alirkan, Sedekah yang ia keluarkan dari harta ketika ia sehat dan hidup. Semua itu akan dikaitkan dengannya setelah ia mati.”</i>
                <br><br>(HR. Ibnu Majah, no. 242; Al-Baihaqi dalam Syu’ab Al-Iman. Hadits ini dishahihkan oleh Ibnu Khuzaimah dan dihasankan oleh Al-Mundziri. Syaikh Al-Albani mengatakan bahwa hadits ini hasan)</small>
            </p>
            {{-- <div class="row">
              <div class="col-lg-4">
                <div class="fact-item">
  ...
  <div id="portfolio" class="our-portfolio section">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-6 offset-lg-3">
          <div class="section-heading">
            <h2>All <em>Documentation</em> of our <span>activities</span></h2>
            <span>Gallery</span>
          </div>
        </div>
      </div>
      ...
      <div class="row">
        <div class="col-lg-12">
          <div class="owl-carousel owl-portfolio">
            <div class="item">
              <div class="thumb">
                <img src="{{ asset('img/portofolio/01.png') }}" alt="">
                <div class="hover-effect">
                  <div class="inner-content">
                    <a rel="sponsored" href="https://templatemo.com/tm-564-plot-listing" target="_parent"><h4>Wakaf Al-Quran Untuk Orang Tua</h4></a>
                    <span>Indonesia</span>
                  </div>
                </div>
              </div>
            ...
            <div class="item">
              <div class="thumb">
                <img src="{{ asset('img/portofolio/02.png') }}" alt="">
                <div class="hover-effect">
                  <div class="inner-content">
                    <a href="#"><h4>Wakaf Al-Quran Untuk Anak-anak</h4></a>
                    <span>Indonesia</span>
                  </div>
                </div>
              </div>
            ...
            <div class="item">
              <div class="thumb">
                <img src="{{ asset('img/portofolio/03.png') }}" alt="">
                <div class="hover-effect">
                  <div class="inner-content">
                    <a rel="sponsored" href="https://templatemo.com/tm-562-space-dynamic" target="_parent"><h4>Wakaf Al-Quran Untuk Orang Dewasa</h4></a>
                    <span>Indonesia</span>
                  </div>
                </div>
              </div>
            ...
            <div class="item">
              <div class="thumb">
                <img src="{{ asset('img/portofolio/04.png') }}" alt="">
                <div class="hover-effect">
                  <div class="inner-content">
                    <a href="#"><h4>Wakaf Al-Quran Untuk Anak-anak</h4></a>
                    <span>Indonesia</span>
            ...
            <div class="item">
              <div class="thumb">
                <img src="{{ asset('img/portofolio/05.png') }}" alt="">
                <div class="hover-effect">
                  <div class="inner-content">
                    <a href="#"><h4>Wakaf Al-Quran Untuk Orang Tua</h4></a>
                    <span>Indonesia</span>
                  </div>
                </div>
              </div>
            ...
            <div class="item">
              <div class="thumb">
                <img src="{{ asset('img/portofolio/06.png') }}" alt="">
                <div class="hover-effect">
                  <div class="inner-content">
                    <a href="#"><h4>Wakaf Al-Quran Untuk Taman Pendidikan Al-Quran (TPA)</h4></a>
                    <span>Indonesia</span>
                  </div>
                </div>
              </div>
            ...
            <div class="item">
              <div class="thumb">
                <img src="{{ asset('img/portofolio/07.png') }}" alt="">
                <div class="hover-effect">
                  <div class="inner-content">
                    <a href="#"><h4>Wakaf Al-Quran Untuk Anak-anak</h4></a>
                    <span>Indonesia</span>
            ...
            <div class="item">
              <div class="thumb">
                <img src="{{ asset('img/portofolio/08.png') }}" alt="">
                <div class="hover-effect">
                  <div class="inner-content">
                    <a href="#"><h4>Wakaf Al-Quran Untuk Anak-anak</h4></a>
                    <span>Indonesia</span>
            ...
            <div class="item">
              <div class="thumb">
                <img src="{{ asset('img/portofolio/09.png') }}" alt="">
                <div class="hover-effect">
                  <div class="inner-content">
                    <a href="#"><h4>Wakaf Al-Quran Untuk Orang Tua</h4></a>
                    <span>Indonesia</span>
            ...
            <div class="item">
              <div class="thumb">
                <img src="{{ asset('img/portofolio/10.png') }}" alt="">
                <div class="hover-effect">
                  <div class="inner-content">
                    <a href="#"><h4>Wakaf Al-Quran Untuk Anak-anak</h4></a>
                    <span>Indonesia</span>
            ...
            <div class="item">
              <div class="thumb">
                <img src="{{ asset('img/portofolio/11.png') }}" alt="">
                <div class="hover-effect">
                  <div class="inner-content">
                    <a href="#"><h4>Wakaf Al-Quran Untuk Taman Pendidikan Al-Quran (TPA)</h4></a>
                    <span>Indonesia</span>
            ...
            <div class="item">
              <div class="thumb">
                <img src="{{ asset('img/portofolio/12.png') }}" alt="">
                <div class="hover-effect">
                  <div class="inner-content">
                    <a href="#"><h4>Wakaf Al-Quran Untuk Hafidz/Hafidzah</h4></a>
                    <span>Indonesia</span>
                  </div>
                </div>
              </div>
